...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        cursor: zod_1.z.number().nullish(), // the last element that was rendered
        query: query_validator_1.QueryValidator,
    }))
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOptions, payload, parsedQueryOptions, page, _b, items, hasNextPage, nextPage;
